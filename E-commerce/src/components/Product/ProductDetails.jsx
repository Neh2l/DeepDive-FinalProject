      ...
      <div className="flex flex-col">
        ...
        <div className="mt-7 flex flex-wrap items-end gap-3">
          ...
          {oldPrice && (
            <>
              ...
              <span className="rounded-md bg-red-50 px-2.5 py-1 text-xs font-black text-red-500">
                {discount}% OFF
              </span>
            </>
          )}
        ...
        <div>
          ...
          <div className="flex w-fit items-center overflow-hidden rounded-xl border border-gray-200">
            ...
            <span className="flex h-12 min-w-14 items-center justify-center border-x border-gray-200 text-sm font-black">
              {quantity}
            </span>
