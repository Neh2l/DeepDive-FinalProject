  ...
  if (!items || items.length === 0) {
    return (
      <div className="flex min-h-[420px] flex-col items-center justify-center px-4 text-center">
        <div className="mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-yellow-50 text-yellow-500 ring-1 ring-yellow-200">
        ...
        <p className="mb-7 max-w-sm text-sm leading-6 text-gray-500">
  ...
  return (
    <div>
      ...
      <div className="mb-5 flex items-center justify-between border-b border-gray-100 pb-5">
        ...
        <span className="rounded-full bg-green-50 px-3 py-1.5 text-[11px] font-bold text-green-600">
          Ready to checkout
        </span>
      </div>
