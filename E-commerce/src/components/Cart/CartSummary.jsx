...
function CartSummary() { 
  ...
  return ( 
    <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-[0_10px_35px_rgba(0,0,0,0.06)] dark:border-[#2a2a2a] dark:bg-[#1a1a1a]"> 
      ...
      {/* Free Delivery */} 
      <div className="border-b border-gray-100 bg-[#fffdf2] p-6 dark:border-[#2a2a2a] dark:bg-[#2a2500]"> 
        ...
        {/* Progress */} 
        <div className="h-2 overflow-hidden rounded-full bg-gray-200 dark:bg-[#3a3a3a]"> 
          <div 
            className={ 
      ...
      <div className="space-y-4 p-6"> 
        ...
        <div className="flex items-end justify-between"> 
          ...
          <span className="rounded-full bg-gray-100 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-gray-500 dark:bg-[#2a2a2a] dark:text-gray-300"> 
            USD 
          </span> 
        </div> 
        ...
        <div className="grid grid-cols-2 gap-2 pt-2"> 
          <div className="flex items-center gap-2 rounded-xl border border-gray-100 bg-gray-50 p-3 dark:border-[#2a2a2a] dark:bg-[#171717]"> 
            <FiShield 
              className="shrink-0 text-gray-700 dark:text-gray-300" 
              size={15} 
            /> 
 
            <span className="text-[10px] font-medium leading-4 text-gray-500 dark:text-gray-400"> 
              Secure checkout 
            </span> 
          </div> 
