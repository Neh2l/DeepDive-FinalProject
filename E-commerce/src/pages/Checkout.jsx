  ...
  if (items.length === 0) { 
    return ( 
      <main className="min-h-screen bg-[#f7f7f7] px-4 py-16 dark:bg-[#111111]"> 
        <div className="mx-auto max-w-xl rounded-3xl border border-gray-200 bg-white p-10 text-center shadow-sm dark:border-[#2a2a2a] dark:bg-[#1a1a1a]"> 
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8"> 
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_380px] lg:items-start"> 
          ...
          <div className="space-y-6"> 
              ...
              <div className="grid gap-5 sm:grid-cols-2"> 
                ...
                <div> 
                  ...
                  <div className="relative"> 
                    ...
                    <input 
                      ...
                      className="w-full rounded-2xl border border-gray-200 bg-gray-50 py-3.5 pl-11 pr-4 text-sm font-medium outline-none transition focus:border-gray-900 focus:bg-white dark:border-[#2a2a2a] dark:bg-[#222] dark:text-white dark:placeholder:text-gray-500 dark:focus:border-gray-500 dark:focus:bg-[#222]" 
                    /> 
                  </div> 
                </div> 
                ...
                <div> 
                  ...
                  <input 
                    ...
                    onChange={handleChange} 
                    placeholder="Cairo" 
                    className="w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3.5 text-sm font-medium outline-none transition focus:border-gray-900 focus:bg-white dark:border-[#2a2a2a] dark:bg-[#222] dark:text-white dark:placeholder:text-gray-500 dark:focus:border-gray-500 dark:focus:bg-[#222]" 
                  /> 
                </div> 
            ...
            <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] sm:p-7 dark:border-[#2a2a2a] dark:bg-[#1a1a1a]"> 
              <div className="mb-6 flex items-center gap-3"> 
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gray-100 text-gray-800 dark:bg-[#222] dark:text-gray-200"> 
              ...
              <div className="rounded-2xl border-2 border-gray-900 bg-gray-50 p-4 dark:border-white dark:bg-[#222]"> 
          ...
          <aside className="lg:sticky lg:top-6"> 
            <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-[0_10px_35px_rgba(0,0,0,0.06)] dark:border-[#2a2a2a] dark:bg-[#1a1a1a]"> 
              ...
              <div className="max-h-[340px] space-y-4 overflow-y-auto p-6"> 
                {items.map((item) => ( 
                  ...
                  > 
                    <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-xl bg-gray-100 dark:bg-[#222]"> 
              ...
              <div className="border-t border-gray-100 p-6 dark:border-[#2a2a2a]"> 
