  ...
  return (
    <article className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
      ...
      <div className="p-5 sm:p-6">
        <div className="flex flex-wrap gap-3">
          {firstItems.map((item, index) => {
            ...
            return (
              <div
                key={`${order._id}-${index}`}
                className="relative h-20 w-20 overflow-hidden rounded-2xl bg-gray-100"
              >
                {productImage ? (
                  <img
                    src={productImage}
        ...
        <Link
          to={`/orders/${order._id}`}
          className="group mt-6 flex items-center justify-center gap-2 rounded-2xl border border-gray-200 py-3.5 text-sm font-black text-gray-800 transition hover:border-gray-900 hover:bg-gray-900 hover:text-white"
        >
          View Order
